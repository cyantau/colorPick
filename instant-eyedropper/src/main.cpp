...
//#pragma  comment(lib, "C:\\Program Files (x86)\\Windows Kits\\10\\Lib\\10.0.19041.0\\um\\x64\\ComCtl32.Lib")       // |________|__|__|__|
//                                                    __   __ 
#include <sstream>                          // .-----|  |_|  |
#include <string>                           // |__ --|   _|  |
...
/***********************************************************************************************************/
int WINAPI WinMain(_In_ HINSTANCE hinst,         // место программы в памяти, Обычно: 0x00400000
                   _In_opt_ HINSTANCE hprevinst,     // предыдущий instance, всегда NULL
                   _In_ LPSTR    cmdparam,      // содержимое командной строки ( без fullpath )
                   _In_ int      cmdshow)       // состояние окна. значение которое отправляется в ShowWindow()
{
    CodeTest();
    InitCommonControls();
    ...
    #define IDI_ICON1     102 //just for IDE does not appear "identifier is undefined warning"
